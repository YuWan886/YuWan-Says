...
scoreboard players set @a MinecartRideCm 0
scoreboard players set #Game MinecartRideCm 0

execute store result score #Game MinecartRideCm run random value 6400..25600

tellraw @a ["",{text:"[Tip]",color:"yellow"},{text: "乘坐矿车移动至少",color: "gray",italic:true},{score:{name:"#Game",objective:"MinecartRideCm"},color:"aqua"},{text: "cm"}]